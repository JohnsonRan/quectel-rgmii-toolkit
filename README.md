...
```bash
adb shell "cd /tmp && wget -O RMxxx_rgmii_toolkit.sh https://ghp.ci/raw.githubusercontent.com/JohnsonRan/quectel-rgmii-toolkit/main/RMxxx_rgmii_toolkit.sh && chmod +x RMxxx_rgmii_toolkit.sh && ./RMxxx_rgmii_toolkit.sh" && cd /
```
...
Then run
```
cd /tmp && wget -O RMxxx_rgmii_toolkit.sh https://ghp.ci/raw.githubusercontent.com/JohnsonRan/quectel-rgmii-toolkit/main/RMxxx_rgmii_toolkit.sh && chmod +x RMxxx_rgmii_toolkit.sh && ./RMxxx_rgmii_toolkit.sh && cd /
```
**You should see:**
