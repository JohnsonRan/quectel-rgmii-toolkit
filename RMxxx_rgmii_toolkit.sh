...
set_simpleadmin_passwd(){
	...
	wget -O /usrdata/root/bin/htpasswd https://ghp.ci/raw.githubusercontent.com/$GITUSER/quectel-rgmii-toolkit/$GITTREE/simpleadmin/htpasswd && chmod +x /usrdata/root/bin/htpasswd
	wget -O /usrdata/root/bin/simplepasswd https://ghp.ci/raw.githubusercontent.com/$GITUSER/quectel-rgmii-toolkit/$GITTREE/simpleadmin/simplepasswd && chmod +x /usrdata/root/bin/simplepasswd
	...
	echo -e "\e[0;33m3) Return to Main Menu\e[0m"
 	echo -e "\e[1;32mSelect your choice: \e[0m"
        ...
        2)
		    ...
		    wget -O /usrdata/simpleupdates/scripts/update_socat-at-bridge.sh https://ghp.ci/raw.githubusercontent.com/$GITUSER/quectel-rgmii-toolkit/$GITTREE/simpleupdates/scripts/update_socat-at-bridge.sh && chmod +x /usrdata/simpleupdates/scripts/update_socat-at-bridge.sh
			...
			sleep 1
		    wget -O /usrdata/simpleupdates/scripts/update_simplefirewall.sh https://ghp.ci/raw.githubusercontent.com/$GITUSER/quectel-rgmii-toolkit/$GITTREE/simpleupdates/scripts/update_simplefirewall.sh && chmod +x /usrdata/simpleupdates/scripts/update_simplefirewall.sh
			...
			sleep 1
			set_simpleadmin_passwd
		    wget -O /usrdata/simpleupdates/scripts/update_simpleadmin.sh https://ghp.ci/raw.githubusercontent.com/$GITUSER/quectel-rgmii-toolkit/$GITTREE/simpleupdates/scripts/update_simpleadmin.sh && chmod +x /usrdata/simpleupdates/scripts/update_simpleadmin.sh
...
echo -e "\e[1;31m2) Installing tailscale from the $GITTREE branch\e[0m"
			...
			mkdir /usrdata/simpleupdates > /dev/null 2>&1
		    mkdir /usrdata/simpleupdates/scripts > /dev/null 2>&1
		    wget -O /usrdata/simpleupdates/scripts/update_tailscale.sh https://ghp.ci/raw.githubusercontent.com/$GITUSER/quectel-rgmii-toolkit/$GITTREE/simpleupdates/scripts/update_tailscale.sh && chmod +x /usrdata/simpleupdates/scripts/update_tailscale.sh
...
install_sshd() {
    ...
    mkdir /usrdata/simpleupdates > /dev/null 2>&1
	mkdir /usrdata/simpleupdates/scripts > /dev/null 2>&1
	wget -O /usrdata/simpleupdates/scripts/update_sshd.sh https://ghp.ci/raw.githubusercontent.com/$GITUSER/quectel-rgmii-toolkit/$GITTREE/simpleupdates/scripts/update_sshd.sh && chmod +x /usrdata/simpleupdates/scripts/update_sshd.sh
...
if echo "$ARCH" | grep -q "aarch64"; then
    cd /tmp && wget -O RM55x_rcPCIe_toolkit.sh https://ghp.ci/raw.githubusercontent.com/JohnsonRan/quectel-rgmii-toolkit/development-SDXPINN/RM55x_rcPCIe_toolkit.sh && chmod +x RM55x_rcPCIe_toolkit.sh && ./RM55x_rcPCIe_toolkit.sh && cd /
    exit 0
